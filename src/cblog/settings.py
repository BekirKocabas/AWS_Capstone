...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cxpehdch1s2v.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'bekirsblog' # please enter your s3 bucket name
